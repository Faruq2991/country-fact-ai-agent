...
def test_rest_countries_tool_directly():
    """
    This function tests your RestCountriesToool directly, outside of the agent,
    to ensure its _run method works as expected.
    """
    print("\n--- Testing RestCountriesTool directly ---")
    tool = RestCountriesTool()
    queries = [
        ...
        "What timezone is Australia in?",  # Now works!
        "What is the flag of Nigeria?",    # Now works!
        "What countries border Germany?",  # New feature!
        "What is the calling code for Ghana?",  # New feature!
...
def run_langgraph_agent():
    """
    This function runs the LangGraph agent.
    """
...
def main():
    ...
    test_rest_countries_tool_directly()
